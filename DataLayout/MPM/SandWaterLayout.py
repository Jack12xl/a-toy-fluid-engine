...
class TwinGridLayout(mpmLayout):
    ...
    def hardening(self, dq, P):
        ...
        q_n_1 += dq
        # (30) friction angle
        phi = self.cfg.h0 + (self.cfg.h1 * q_n_1 - self.cfg.h3) * ti.exp(-self.cfg.h2 * q_n_1)
    ...
    def seed_sand_particle(self, P, x, color, velocity):
        ...
        # what the hell... where these parameters come from...
        self.c_C0[P] = -0.01
