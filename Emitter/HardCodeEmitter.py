...
@ti.data_oriented
class SquareEmitter3D(GridEmitter):
    """
    Directly HardCode the velocity and Density in an area
    """
    ...
    def __init__(self,
        ...
        :param fluid_color:
        """
        super(SquareEmitter3D, self).__init__(t, v, fluid_color)
    ...
    def stepEmitHardCode(self, vf: Matrix, df: Matrix):
        ...
        for I in ti.grouped(ti.ndrange((l_b.x, r_u.x), (l_b.y, r_u.y), (l_b.z, r_u.z))):
            vf[I] = ts.vec3(0.0, 128.0, 0.0)
            # here CFL u * dt / dx
            # vf * 0.03 / 1
            # should be 1 ~ 10
            df[I] = self.fluid_color
